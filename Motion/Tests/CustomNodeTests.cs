...
/// <summary>
/// Nodes written outside the library. These use only the public surface, so anything they need has to
/// stay public: the node bases, the bind context, the playback cursor and a clip's event and root motion
/// sampling.
/// </summary>
