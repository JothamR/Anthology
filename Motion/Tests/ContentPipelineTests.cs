...
/// <summary>
/// Exercises the full viewer pipeline on the real Mixamo FBX: Clay load -> skeleton -> avatar ->
/// clip sampling -> CPU skinning -> retargeting. Catches runtime issues the headless build cannot.
/// </summary>
